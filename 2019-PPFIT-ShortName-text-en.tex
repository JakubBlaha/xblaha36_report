...
The complete formalism -- primitives, entity types, expressions, predicates, operations, temporal constructs, and the definition of a requirement and a test case -- is given in Appendix~\ref{app:formalism}. The remainder of this section refers to those definitions but does not reproduce them.
